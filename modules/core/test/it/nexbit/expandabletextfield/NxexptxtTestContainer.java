package it.nexbit.expandabletextfield;
...
public class NxexptxtTestContainer extends TestContainer {

    public NxexptxtTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "it/nexbit/expandabletextfield/app.properties",
    ...
    public static class Common extends NxexptxtTestContainer {

        public static final NxexptxtTestContainer.Common INSTANCE = new NxexptxtTestContainer.Common();
